...
async function handleMessages(req, res, body) {
  ...
  const wantsNativeTools = hasTools && TOOL_MODE !== 'emulated';
  ...
  let parsed = usedNativeTools ? parseNativeToolCalls(upstreamMessage) : parseToolCalls(rawContent, body.tools);
